...
//	}
	...
	public Passenger getPassenger(@PathParam("passenger_id") Integer passengerId){
		...
		if(p == null){
			throw new NotFoundException("The Passenger with an id of " + passengerId +
					" was not found.");
		}
		return p;
	}
	...
	public Response updatePassenger( @PathParam("pid") Integer passengerId, Passenger pUpdated){
		...
		if(pUpdated == null){
			throw new NotFoundException("The passenger with this id of " + passengerId + " was not found.");
		}
